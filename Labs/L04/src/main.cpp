...
static void render()
{
    ...
    glm::vec3 myVector(0.0f, 0.0f, -10.0f);
    MV.translate(myVector);
    int degree = 45;
    float angle = 0;
    degree = 40;
    angle =  degree * (M_PI / 180.0);
    MV.rotate(-angle, glm::vec3(-1.0f, 1.0f, 0.0f));
    
    MV.pushMatrix();
    //Transform and Draw Cuboid 1
    // translate -> rotate -> scale
    
    glm::vec3 cuboid1Translate(-5.5f, 0.0f, -3.5f);
    MV.translate(cuboid1Translate);
    
    degree = 60;
    angle =  degree * (M_PI / 180.0);
    MV.rotate(angle, glm::vec3(0.0f, 0.0f, 1.0f));
   
    glm::vec3 cuboid1Scale(5.0f, 0.5f, 1.0f);
    MV.scale(cuboid1Scale);
    ...
    glm::vec3 cuboid2Translate(-4.3f, 0.0f, -3.5f);
    MV.translate(cuboid2Translate);
    
    degree = 0;
    angle =  degree * (M_PI / 180.0);
    MV.rotate(angle, glm::vec3(0.0f, 0.0f, 1.0f));
   
    glm::vec3 cuboid2Scale(2.5f, 0.5f, 1.0f);
    MV.scale(cuboid2Scale);
    ...
    glm::vec3 cuboid3Translate(-3.1f, 0.0f, -3.5f);
    MV.translate(cuboid3Translate);
    
    degree = -60;
    angle =  degree * (M_PI / 180.0);
    MV.rotate(angle, glm::vec3(0.0f, 0.0f, 1.0f));
   
    glm::vec3 cuboid3Scale(5.0f, 0.5f, 1.0f);
    MV.scale(cuboid3Scale);
    ...
    glm::vec3 Zcuboid1Translate(2.3f, 1.9f, -3.5f);
    MV.translate(Zcuboid1Translate);
    
    degree = 0;
    angle =  degree * (M_PI / 180.0);
    MV.rotate(angle, glm::vec3(0.0f, 0.0f, 1.0f));
   
    glm::vec3 Zcuboid1Scale(3.5f, 0.5f, 1.0f);
    MV.scale(Zcuboid1Scale);
    ...
    MV.pushMatrix();
    // TRANSFORM AND DRAW CUBOID #2
    glm::vec3 Zcuboid2Translate(2.3f, 0.0f, -3.5f);
    MV.translate(Zcuboid2Translate);
    
    degree = 50;
    angle =  degree * (M_PI / 180.0);
    MV.rotate(angle, glm::vec3(0.0f, 0.0f, 1.0f));
   
    glm::vec3 Zcuboid2Scale(5.0f, 0.5f, 1.0f);
    MV.scale(Zcuboid2Scale);
    ...
    // TRANSFORM AND DRAW CUBOID #3
    //bottom cube
    glm::vec3 Zcuboid3Translate(2.3f, -2.0f, -3.5f);
    MV.translate(Zcuboid3Translate);
    
    degree = 0;
    angle =  degree * (M_PI / 180.0);
    MV.rotate(angle, glm::vec3(0.0f, 0.0f, 1.0f));
   
    glm::vec3 Zcuboid3Scale(3.5f, 0.5f, 1.0f);
    MV.scale(Zcuboid3Scale);
